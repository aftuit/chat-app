  ...
  <div v-else class="h-screen w-screen p-5 overflow-hidden">
    <div class="grid grid-cols-12 h-full gap-3">
      ...
      <div class="col-span-9 h-full border rounded-xl flex flex-col shadow">
        ...
        <div class="h-16">
          <div class="flex justify-end items-center p-3">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"
              class="rotate-180 cursor-pointer" @click="logout">
        ...
        <div class="overflow-auto p-3 shadow-inner flex flex-col chat-container" style="height: calc(100vh - 10.5rem)">
          <ul class="flex flex-col-reverse h-full overflow-y-auto gap-2 px-2" v-if="selectedChat?.id" id="message-list">
